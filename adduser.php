                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="adduser.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <label>Image</label>
                                            <input type="file" name="image" class="form-control" accept="img/*" required>
                                            ...
                                            <div class="checkbox">
                                            <label><input type="checkbox" name="Rupapur"> Rupapur</label>
                                            </div>
                                            <div class="checkbox">
                                            <label><input type="checkbox" name="Loni"> Loni</label>
                                            </div>
                                            <div class="checkbox">
                                            <label><input type="checkbox" name="Ajbapur"> Ajbapur</label>
                                            </div>
                                            <div class="checkbox">
                                            <label><input type="checkbox" name="Hariawan" > Hariawan</label>
                                            </div>
...
if (isset($_POST['submit'])) {
    ...
    $Rupapur = $_POST['Rupapur'];
    $Loni = $_POST['Loni'];
    $Ajbapur = $_POST['Ajbapur'];
    $Hariawan = $_POST['Hariawan'];
    ...
    $newFileName = "user-$date".time();
    move_uploaded_file($file_tmp,"images/".$newFileName.'.'.$ext);
    
    $filenameToStore="http://localhost/adminpanel/images/".$newFileName.".".$ext;
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $sql1 = "INSERT INTO `users`(`name`, `email`, `password`, `type`, `status`, `permission`,`img` )
         VALUES ('$name','$email','$password','$type',1 , '$permisiion','$filenameToStore')";
