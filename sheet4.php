...
if(!isset($_GET['id'])){
    header('Location: sheet4.php?id=311194363');
}
else{
    $id = $_GET['id'];
}
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="btn-group">
                                            <a type="button" href="?id=311194363" class="btn ">BBS</a>
											<a type="button" href="?id=1712444525" class="btn">SURAKSHA</a>
                                            <a type="button" href="?id=1567735217" class="btn ">SUJHAV</a>
                                            <a type="button" href="?id=1717930169" class="btn">OBSERVER</a>
                                            <a type="button" href="?id=1164604924" class="btn ">COVID LOCATIONS</a>
                                            <a type="button" href="?id=1286920158" class="btn ">COVID WARRIORS</a>
...
<script>
    var id = <?php echo $id; ?>;
    var mySpreadsheet = 'https://docs.google.com/spreadsheets/d/1HWzn2vkPMfPxK6FN6SixYR0-kZmCOGG8vy9lhTn_ias/edit#gid=' + id;
...
function exportF(elem) {
  ...
  elem.setAttribute("download", "Hariyawan_BBS_Data.xls"); // Choose the file name
  return false;
}
</script>
</html>