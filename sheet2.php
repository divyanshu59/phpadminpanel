...
if(!isset($_GET['id'])){
    header('Location: sheet2.php?id=0');
}
else{
    $id = $_GET['id'];
}
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="btn-group">
											...
											<a type="button" href="?id=40818542" class="btn">SURAKSHA</a>
                                            <a type="button" href="?id=294432667" class="btn ">SUJHAV</a>
                                            <a type="button" href="?id=68777519" class="btn">OBSERVER</a>
                                            <a type="button" href="?id=1694540768" class="btn ">COVID LOCATIONS</a>
                                            <a type="button" href="?id=1203613772" class="btn ">COVID WARRIORS</a>
...
<script>
    var id = <?php echo $id; ?>;
    var mySpreadsheet = 'https://docs.google.com/spreadsheets/d/1Byvoa8m50DeB0nPtKTcFiIfyQoFmneJF7joUbKSQ3H0/edit#gid=' + id;
...
function exportF(elem) {
  ...
  elem.setAttribute("download", "Loni_BBS_Data.xls"); // Choose the file name
  return false;
}
</script>
