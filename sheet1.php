                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="btn-group">
											...
											<a type="button" href="?id=799364203" class="btn">SURAKSHA</a>
                                            <a type="button" href="?id=883110588" class="btn ">SUJHAV</a>
                                            <a type="button" href="?id=1686629630" class="btn">OBSERVER</a>
                                            <a type="button" href="?id=1954344263" class="btn ">COVID LOCATIONS</a>
                                            <a type="button" href="?id=432725266" class="btn ">COVID WARRIORS</a>
...
<script>
    var id = <?php echo $id; ?>;
    var mySpreadsheet = 'https://docs.google.com/spreadsheets/d/1u6rGk3ycEPFVm5reZvobOt6XKv2PB4-T_HbGsRCtUpE/edit?ts=5f270a0d#gid=' + id;
...
function exportF(elem) {
  ...
  elem.setAttribute("download", "Rupapur_BBS_Data.xls"); // Choose the file name
  return false;
}
</script>
